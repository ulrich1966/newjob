...
/**
 * Triggert das weiterverfolgen einer zuvor geschlossenen Bewerbung
 * Auf eine Wiedereroeffung folgend sind volgene Stausaenderungen moeglich:
 *
 * {@link InProgress}
 * 
 ...
 *
 */
public class ReOpen extends State {
	...
	public State inProgress() {
		if(controller.run(this, "Bewerbung nach Wiereröffnung für den Bewerbungspozess frei gegeben")) {
			return StateContext.IN_PROGRESS;
		}
		return this;
	}

...
public class Closed extends State {
	...
	@Override
	public State delete() {
		if(controller.run(this, "Bewerbung wird geköscht, nachdem sie gschlossen wurde")) {
	...
	@Override
	public State reopen() {
		if(controller.run(this, "Bewerbung wird widereröffnet, nachdem sie gschlossen wurde")) {
